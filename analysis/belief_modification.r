...
path = "stats/modification"

# %% ==================== Load data ====================

human_raw = read_csv('../data/experiments/reported_experiments/optimal_nudging_changing_belief_state.csv', col_types = cols())
